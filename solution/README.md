...
**Why hybrid rules + LLM?** The rule engine (Stage A) reduces LLM calls by ~80%. The LLM only processes candidates already detected by rules — it never invents flags from scratch.
